...
// Instead of generating keys at random, a text file can be fed in
// to determine character output. This logic would need to be moved to
// the game class, feeding in the character into new Block
